...
const featuresData: Feature[] = [
  {
    id: 1,
    icon: <SwatchBook width="40" height="40" className="text-blue-500" />, // Replace MousePointerClick with the actual icon name you want to use
  ...
  {
    id: 2,
    icon: <ShieldHalf width="40" height="40" className="text-blue-500" />, // Replace ShieldHalf with the actual icon name you want to use
  ...
  {
    id: 3,
    icon: <ScrollText width="40" height="40" className="text-blue-500" />, // Replace AccessIcon with the actual icon name you want to use
  ...
  {
    id: 4,
    icon: <MousePointerClick width="40" height="40" className="text-blue-500" />, // Replace DesignIcon with the actual icon name you want to use
  ...
  {
    id: 5,
    icon: <Webhook width="40" height="40" className="text-blue-500" />, // Replace SupportIcon with the actual icon name you want to use
  ...
  {
    id: 6,
    icon: <SmartphoneNfc width="40" height="40" className="text-blue-500" />, // Replace PaymentIcon with the actual icon name you want to use
